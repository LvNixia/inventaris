...
class PanelAccessTest extends TestCase
{
    ...
    public static function halamanUtama(): array
    {
        return [
            ...
            'daftar penerimaan barang' => ['/admin/goods-receipts'],
            'buat penerimaan barang' => ['/admin/goods-receipts/create'],
            'daftar faktur vendor' => ['/admin/purchase-invoices'],
            'buat faktur vendor' => ['/admin/purchase-invoices/create'],
            'daftar pembayaran vendor' => ['/admin/vendor-payments'],
            'buat pembayaran vendor' => ['/admin/vendor-payments/create'],
            'laporan hutang vendor' => ['/admin/laporan-hutang-vendor'],
            'daftar syarat pembayaran' => ['/admin/payment-terms'],
            'daftar vendor' => ['/admin/vendors'],
            ...
            'laporan stok cabang' => ['/admin/laporan-stok-cabang'],
